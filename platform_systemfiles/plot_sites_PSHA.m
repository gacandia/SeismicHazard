...
switch handles.po_sites.Value
    case 0, scatter(handles.ax1,site(:,2),site(:,1),16,c,'filled','markeredgecolor','none','tag','siteplot','ButtonDownFcn',{@site_click_PSHA;handles;1},'visible','off');
    case 1, scatter(handles.ax1,site(:,2),site(:,1),16,c,'filled','markeredgecolor','none','tag','siteplot','ButtonDownFcn',{@site_click_PSHA;handles;1},'visible','on');
end
