function varargout = Settle_LogicTree(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Settle_LogicTree_OpeningFcn, ...
    'gui_OutputFcn',  @Settle_LogicTree_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function Settle_LogicTree_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
handles.output = [];
...
function varargout = Settle_LogicTree_OutputFcn(hObject, eventdata, handles)
